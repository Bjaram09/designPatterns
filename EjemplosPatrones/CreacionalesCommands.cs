...
public class PrototypeCommand : ICommand
{
    public void Ejecutar()
    {
        ...
        Reporte reporteCopia = reporteBase.Copy();
...
public class FactoryCommand : ICommand
{
    public void Ejecutar()
    {
...
public class AbstractFactoryCommand : ICommand
{
    public void Ejecutar()
    {
